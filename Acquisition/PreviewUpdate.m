...
global total_frame_count savecount frame_queue diffarray vid rROI w frame_queue_length;
    ...
    try
        ...
        % Get the frame
        captured_frame = event.Data;

        % Display the current image frame.
        set(hImage, 'CData', captured_frame);

        % Add it to the frame queue
        current_frame_index = total_frame_count;
        frame_queue(:,:,current_frame_index)= captured_frame;
