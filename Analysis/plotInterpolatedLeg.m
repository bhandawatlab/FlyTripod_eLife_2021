function plotInterpolatedLeg(tracking_data_file, tracking_data)
    ...
    gif_filename = [split_filename{1} '_AP-axis-Interp.gif'];
    gif_xz_filename = [split_filename{1} '_AP-axis-XZ-Interp.gif'];
